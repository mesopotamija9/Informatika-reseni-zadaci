...
type
  TForm1 = class(TForm)
    MainMenu1: TMainMenu;
    Poslovnik1: TMenuItem;
    Komitenti1: TMenuItem;
    Adresar1: TMenuItem;
    Berza1: TMenuItem;
    ransakcije1: TMenuItem;
    Krediti1: TMenuItem;
    N1: TMenuItem;
    uplateNovca1: TMenuItem;
    elekom1: TMenuItem;
    Automobilski1: TMenuItem;
    Stambeni1: TMenuItem;
    Namenski1: TMenuItem;
    KrajRada1: TMenuItem;
    procedure uplateNovca1Click(Sender: TObject);
...
procedure TForm1.uplateNovca1Click(Sender: TObject);
begin
  Form2.showmodal;
end;
